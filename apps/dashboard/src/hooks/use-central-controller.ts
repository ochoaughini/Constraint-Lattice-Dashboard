...
import type { AppState, ControllerAction } from '../types';
const ControllerContext = require('../contexts/ControllerContext.jsx');

export const useCentralController = () => {
  const service = useContext(ControllerContext);
  if (!service) {
